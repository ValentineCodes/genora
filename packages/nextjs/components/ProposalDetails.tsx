...
const description = `# Kitso: Mobile Decentralized App Starter Kit for LUKSO
...
export default function ProposalDetails({}: Props) {
  return (
    <div className="p-4 flex flex-col h-[80vh]">
      ...
      <text className="text-xs mb-4">Sept 4, 2025</text>
      <div className="overflow-auto flex-1" dangerouslySetInnerHTML={{ __html: converter.makeHtml(description) }}></div>
